...
export const StanfordPersonData = () => {
  return {
    ...
    body: {
      processed:
        "Facilisis arcu sit vel tempus tincidunt congue sem lacus interdum fusce portaest mi proin suspendisse ex consectetur felis sollicitudin pellentesque suspendisse hendrerit ex sem arcu.\nVarius enim morbi metus felis euismod eros vivamus erat interdum ipsum ex cursus nisi erat aliquam eget aliquam eget orci quisque pellentesque maecenas elementum nisi.",
    },
